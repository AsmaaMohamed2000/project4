...
let favHead = document.querySelector(".Favourite-items");
let logout = document.querySelector(".logout");
let noItemDiv = document.querySelector(".noitems");
...
function showFavs(FavArray) {
  ...
  if (favContainet.innerHTML === "") {
    favHead.remove();
  }
}
function noItems() {
  if (favContainet.innerHTML === "" && addedToCard.innerHTML === "") {
    container.remove();
